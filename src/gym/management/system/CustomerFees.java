 ...
 */
public class CustomerFees extends javax.swing.JFrame {
    ...
    public void tableDetails()
    {
        ...
        try
        {
            ...
            ResultSet rs =st.executeQuery("select * from CustomerFees where id='"+id+"'");
            while(rs.next())
            {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs1=st.executeQuery("Select * from CustomerFees inner join member where Customer.month='"+month+"' and payment.id='"+id+"' and member.id='"+id+"'");
            while(rs1.next())
            {
